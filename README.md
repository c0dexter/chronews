...
> Click the above icon to read documenation of project scratch. 
>This is a description of an idea of this app and steps how to develop application in a chronology order.
> New features will be described in V2 of this documentation.
